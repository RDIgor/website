            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <select name="avlaibility">
                            <option value="1" <?php if ($product['avlaibility'] == 1) echo ' selected="selected"'; ?>>Да</option>
                            <option value="0" <?php if ($product['avlaibility'] == 0) echo ' selected="selected"'; ?>>Нет</option>
                        </select>
