...
class CartController
{
    ...
    public function actionIndex()
    {
        ...
        if ($productsInCart) {
            ...
            $products = Products::getProdustsByIds($productsIds);
            ...
            {
                if ($productsInCart[$pr['id']] > $pr['avlaibility'])
                {
                    $error = true;
                    break;
                }
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                $result = Order::save($userName, $userPhone, $userComment,$userCountry, $userId, $productsInCart);
